        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="ribbon-title">Tran 3A</div>
                        <div class="body">
                            <section id="wizard" class="steps-wizard">
                                <form id="commentForm" method="get" action="">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped table-hover" id="tran3a">
                                            <thead>
                                                <tr>
                                                    <th>CTD No.</th>
                                                    <th>Invoices no. against which CTD has been issued</th>
                                                    <th>Invoice date</th>
                                                    <th>Months in which these clearances were made against the invoices</th>
                                                    ...
                                                    <th><button id="addRowTran3A" type="button" class="btn bg-indigo m-b-10">Add row</button></th>
                                                </tr>
                                            </thead>
                                            <tbody id="tran3atbody">
                                                <tr>
                                                    <td>
